...
if (check_permission($path)) {
  if (file_exists($path) && is_file($path)) {
    ...
    echo "<div class=\"row box\"><div class=\"col-xs-12 mediacontainer\"><div class=\"row\"><div class=\"col-xs-12\" style=\"margin-bottom:10px;\">Download Link: <a href=\"$fullurl\" class=\"filelink\">$filename</a></div></div>";
